...
set(MSG_I_FLAGS "-Irotors_comm:/home/chris/RoVi_gazebo/src/rotors_simulator/rotors_comm/msg;-Igeometry_msgs:/opt/ros/melodic/share/geometry_msgs/cmake/../msg;-Ioctomap_msgs:/opt/ros/melodic/share/octomap_msgs/cmake/../msg;-Istd_msgs:/opt/ros/melodic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/chris/RoVi_gazebo/src/rotors_simulator/rotors_comm/srv/Octomap.srv" NAME_WE)
add_custom_target(_rotors_comm_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "rotors_comm" "/home/chris/RoVi_gazebo/src/rotors_simulator/rotors_comm/srv/Octomap.srv" "octomap_msgs/Octomap:std_msgs/Header:geometry_msgs/Point"
)

get_filename_component(_filename "/home/chris/RoVi_gazebo/src/rotors_simulator/rotors_comm/msg/WindSpeed.msg" NAME_WE)
add_custom_target(_rotors_comm_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "rotors_comm" "/home/chris/RoVi_gazebo/src/rotors_simulator/rotors_comm/msg/WindSpeed.msg" "geometry_msgs/Vector3:std_msgs/Header"
)

get_filename_component(_filename "/home/chris/RoVi_gazebo/src/rotors_simulator/rotors_comm/srv/RecordRosbag.srv" NAME_WE)
add_custom_target(_rotors_comm_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "rotors_comm" "/home/chris/RoVi_gazebo/src/rotors_simulator/rotors_comm/srv/RecordRosbag.srv" ""
)
...
_generate_msg_cpp(rotors_comm
  "/home/chris/RoVi_gazebo/src/rotors_simulator/rotors_comm/msg/WindSpeed.msg"
  "${MSG_I_FLAGS}"
